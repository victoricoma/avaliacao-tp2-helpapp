...
namespace AppHelper.Domain.Tests;
...
public class ProductUnitTest1
{
    ...
    public void CreateProduct_WithValidParameters_ResultObjectValidState()
    {
        Action action = () => new Product(1, "Product Name", "Product Description", 9.99m,
            99, "product image");
        action.Should()
            .NotThrow<AppHelper.Domain.Validation.DomainExceptionValidation>();
    }
    ...
    public void CreateProduct_NegativeIdValue_DomainExceptionInvalidId()
    {
        ...
        action.Should().Throw<AppHelper.Domain.Validation.DomainExceptionValidation>()
    ...
    public void CreateProduct_LongImageName_DomainExceptionLongImageName()
    {
        ...
        action.Should()
            .Throw<AppHelper.Domain.Validation.DomainExceptionValidation>()
    ...
    public void CreateProduct_WithNullImageName_NoDomainException()
    {
        ...
        action.Should().NotThrow<AppHelper.Domain.Validation.DomainExceptionValidation>();
    }
